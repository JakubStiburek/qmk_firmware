 ...
 */
    [_QWERTY] = LAYOUT(
     ...
     KC_LSFT , KC_Z ,  KC_X   ,  KC_C  ,   KC_V  ,   KC_B  , KC_CAPS , KC_HYPR  , TG(_MEOR)     , LOGOUT   ,    KC_N  ,   KC_M , KC_COMM , KC_DOT , KC_SLSH , KC_RSFT,
                                KC_ESC , KC_LALT , KC_LCTL , KC_SPC  , MO(_NUM) , MO(_FUNCTION) , KC_EQL   , KC_PLUS ,  KC_BSLS , SWITCH_LANG
    ),
 /*
  * Layer: NUM
  * TODO layout
...
/*s
 ...
 [_MEOR] = LAYOUT(
       ...
       KC_NO    , KC_NO ,  KC_NO , KC_NO   , KC_NO   , KC_NO   , KC_NO , KC_NO , TG(_MEOR) , KC_NO ,   KC_NO , KC_NO   , KC_NO    , KC_NO    , KC_NO  , KC_NO,
                                             KC_NO   , KC_LALT , KC_NO , KC_NO , KC_NO     , KC_NO ,   KC_NO ,  KC_NO  , KC_NO    , KC_NO
      )
};
